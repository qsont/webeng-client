					...
					{isAuthenticated ? (
						<div>
							...
							{isProfileDropdownOpen && (
								<div className="absolute right-0 z-50 mt-2 w-56 rounded-lg border border-border bg-popover py-2 shadow-xl">
									<button
									...
									<button
										...
										className="flex w-full items-center gap-3 rounded-b-lg px-4 py-2 text-left text-sm text-red-600 transition-colors hover:bg-red-50 dark:hover:bg-red-500/10"
									>
